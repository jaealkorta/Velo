...
QtObject {
    ...
    property string primaryScreen: config.stringValue("primary-screen") // @possible:Screen name, e.g. 'eDP-1' @desc:Screen that shows the lock and login screens (the others only show the background). The Velo app keeps it equal to the primary screen of KDE. If empty, or that screen is not connected, SDDM's primary screen is used.
    property int slideshowInterval: config.stringValue("slideshow-interval") !== "" ? config.intValue("slideshow-interval") : 60 // @possible:Seconds, minimum 5 @desc:Seconds between images when a screen has several images in `background` (separated by `|`). Videos are never rotated.
    ...
    // [LockScreen.Scrim]
    property bool scrimDisplay: config.boolValue("LockScreen.Scrim/display") // @desc:Whether or not to draw soft dark gradients at the top and bottom of the lock screen so the text is readable over any background.
    property color scrimColor: config.stringValue("LockScreen.Scrim/color") || "#000000" // @desc:Color of the gradients.
    property real scrimTopOpacity: config.stringValue("LockScreen.Scrim/top-opacity") !== "" ? config.realValue("LockScreen.Scrim/top-opacity") : 0.55 // @possible:0.0 ≤ R ≤ 1.0 @desc:Opacity of the gradient at the very top edge.
    property real scrimTopHeight: config.stringValue("LockScreen.Scrim/top-height") !== "" ? config.realValue("LockScreen.Scrim/top-height") : 0.5 // @possible:0.0 ≤ R ≤ 1.0 @desc:Height of the top gradient as a fraction of the screen height.
    property real scrimBottomOpacity: config.stringValue("LockScreen.Scrim/bottom-opacity") !== "" ? config.realValue("LockScreen.Scrim/bottom-opacity") : 0.45 // @possible:0.0 ≤ R ≤ 1.0 @desc:Opacity of the gradient at the very bottom edge.
    property real scrimBottomHeight: config.stringValue("LockScreen.Scrim/bottom-height") !== "" ? config.realValue("LockScreen.Scrim/bottom-height") : 0.3 // @possible:0.0 ≤ R ≤ 1.0 @desc:Height of the bottom gradient as a fraction of the screen height.
    ...
    property bool clockOutline: config.boolValue("LockScreen.Clock/outline") // @desc:Whether or not to draw an outline around the clock's letters.
    property color clockOutlineColor: config.stringValue("LockScreen.Clock/outline-color") || "#404040" // @desc:Color of the clock's outline.
    ...
    property bool dateOutline: config.boolValue("LockScreen.Date/outline") // @desc:Whether or not to draw an outline around the date's letters.
    property color dateOutlineColor: config.stringValue("LockScreen.Date/outline-color") || "#404040" // @desc:Color of the date's outline.
    ...
    property bool usernameOutline: config.boolValue("LoginScreen.LoginArea.Username/outline") // @desc:Whether or not to draw an outline around the username's letters.
    property color usernameOutlineColor: config.stringValue("LoginScreen.LoginArea.Username/outline-color") || "#404040" // @desc:Color of the username's outline.

    // [LoginScreen.Card]
    property bool cardDisplay: config.boolValue("LoginScreen.Card/display") // @desc:Whether or not to draw a translucent card behind the avatar, username and password field.
    property color cardColor: config.stringValue("LoginScreen.Card/color") || "#000000" // @desc:Color of the card.
    property real cardOpacity: config.stringValue("LoginScreen.Card/opacity") !== "" ? config.realValue("LoginScreen.Card/opacity") : 0.3 // @possible:0.0 ≤ R ≤ 1.0 @desc:Opacity of the card.
    property int cardRadius: config.stringValue("LoginScreen.Card/radius") !== "" ? config.intValue("LoginScreen.Card/radius") : 10 // @desc:Corner radius of the card.
    property int cardBorderSize: config.intValue("LoginScreen.Card/border-size") // @desc:Size of the card's border. 0 means no border.
    property color cardBorderColor: config.stringValue("LoginScreen.Card/border-color") || "#808080" // @desc:Color of the card's border.
    property int cardPaddingX: config.stringValue("LoginScreen.Card/padding-x") !== "" ? config.intValue("LoginScreen.Card/padding-x") : 60 // @desc:Horizontal space between the content and the card's edge.
    property int cardPaddingY: config.stringValue("LoginScreen.Card/padding-y") !== "" ? config.intValue("LoginScreen.Card/padding-y") : 40 // @desc:Vertical space between the content and the card's edge.
    property int cardHeaderSpacing: config.stringValue("LoginScreen.Card/header-spacing") !== "" ? config.intValue("LoginScreen.Card/header-spacing") : 20 // @desc:Space between the clock/date and the avatar inside the card.

    // [LoginScreen.Scrim]
    property bool loginScrimDisplay: config.boolValue("LoginScreen.Scrim/display") // @desc:Whether or not to draw a soft gradient at the bottom of the login screen so the session/power buttons are readable over any background.
    property color loginScrimColor: config.stringValue("LoginScreen.Scrim/color") || "#000000" // @desc:Color of the gradient.
    property real loginScrimBottomOpacity: config.stringValue("LoginScreen.Scrim/bottom-opacity") !== "" ? config.realValue("LoginScreen.Scrim/bottom-opacity") : 0.45 // @possible:0.0 ≤ R ≤ 1.0 @desc:Opacity of the gradient at the very bottom edge.
    property real loginScrimBottomHeight: config.stringValue("LoginScreen.Scrim/bottom-height") !== "" ? config.realValue("LoginScreen.Scrim/bottom-height") : 0.22 // @possible:0.0 ≤ R ≤ 1.0 @desc:Height of the gradient as a fraction of the screen height.

    // [LoginScreen.Clock]
    property bool loginClockDisplay: config.boolValue("LoginScreen.Clock/display") // @desc:Whether or not to display the clock inside the login card.
    property string loginClockFormat: config.stringValue("LoginScreen.Clock/format") || "hh:mm" // @desc:Format string used for the clock.
    property string loginClockFontFamily: config.stringValue("LoginScreen.Clock/font-family") || "RedHatDisplay" // @desc:Font family used for the clock.
    property int loginClockFontSize: config.intValue("LoginScreen.Clock/font-size") || 60 // @desc:Font size of the clock.
    property int loginClockFontWeight: config.intValue("LoginScreen.Clock/font-weight") || 900 // @desc:Font weight of the clock.
    property color loginClockColor: config.stringValue("LoginScreen.Clock/color") || "#FFFFFF" // @desc:Color of the clock.
    property bool loginClockOutline: config.boolValue("LoginScreen.Clock/outline") // @desc:Whether or not to draw an outline around the clock's letters.
    property color loginClockOutlineColor: config.stringValue("LoginScreen.Clock/outline-color") || "#404040" // @desc:Color of the clock's outline.

    // [LoginScreen.Date]
    property bool loginDateDisplay: config.boolValue("LoginScreen.Date/display") // @desc:Whether or not to display the date inside the login card.
    property string loginDateFormat: config.stringValue("LoginScreen.Date/format") || "dddd, MMMM dd, yyyy" // @desc:Format string used for the date.
    property string loginDateLocale: config.stringValue("LoginScreen.Date/locale") || "en_US" // @desc:Language of the date defined by lang_COUNTRY.
    property string loginDateFontFamily: config.stringValue("LoginScreen.Date/font-family") || "RedHatDisplay" // @desc:Font family used for the date.
    property int loginDateFontSize: config.intValue("LoginScreen.Date/font-size") || 18 // @desc:Font size of the date.
    property int loginDateFontWeight: config.intValue("LoginScreen.Date/font-weight") || 800 // @desc:Font weight of the date.
    property color loginDateColor: config.stringValue("LoginScreen.Date/color") || "#FFFFFF" // @desc:Color of the date.
    property bool loginDateOutline: config.boolValue("LoginScreen.Date/outline") // @desc:Whether or not to draw an outline around the date's letters.
    property color loginDateOutlineColor: config.stringValue("LoginScreen.Date/outline-color") || "#404040" // @desc:Color of the date's outline.
    property int loginDateMarginTop: config.intValue("LoginScreen.Date/margin-top") // @desc:Top margin from the clock.
    ...
    property string tooltipsSessionText: config.stringValue("Tooltips/session-text") || "Change session" // @desc:Tooltip of the session button.
    property string tooltipsLayoutText: config.stringValue("Tooltips/layout-text") || "Change keyboard layout" // @desc:Tooltip of the keyboard layout button.
    property string tooltipsVirtualKeyboardText: config.stringValue("Tooltips/virtual-keyboard-text") || "Toggle virtual keyboard" // @desc:Tooltip of the virtual keyboard button.
    property string tooltipsPowerText: config.stringValue("Tooltips/power-text") || "Power options" // @desc:Tooltip of the power button.
    property string tooltipsSelectUserText: config.stringValue("Tooltips/select-user-text") || "Select user" // @desc:Tooltip of the avatar when there are several users.
    property string tooltipsCloseUserText: config.stringValue("Tooltips/close-user-selection-text") || "Close user selection" // @desc:Tooltip of the avatar while the user list is open.
