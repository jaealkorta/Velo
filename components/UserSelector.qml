    ...
    ListView {
        ...
        delegate: Rectangle {
            ...
            Avatar {
                ...
                tooltipText: active && selector.listUsers ? (Config.avatarAlwaysActive ? "" : Config.tooltipsCloseUserText) : (active && !listUsers ? Config.tooltipsSelectUserText : model.name)
