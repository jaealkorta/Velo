...
Item {
    ...
    Scrim {
        visible: Config.loginScrimDisplay
        edge: "bottom"
        tint: Config.loginScrimColor
        strength: Config.loginScrimBottomOpacity
        extent: Config.loginScrimBottomHeight
    }
    ...
    Item {
        ...
        UserSelector {
            ...
            anchors.topMargin: loginHeader.visible ? loginHeader.height + Config.cardHeaderSpacing * Config.generalScale : 0
        ...
        Item {
            ...
            Text {
                ...
                style: Config.usernameOutline ? Text.Outline : Text.Normal
                styleColor: Config.usernameOutlineColor
